 ...
 * modal. Rendered by the async StickyActions server wrapper, which fetches CMS
 * contact info. Any CTA can open the modal via the store.
 */
export function StickyActionsClient({ phone, whatsapp }: { phone: string; whatsapp: string }) {
